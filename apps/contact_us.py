...
class ContactUsAPP(HydraHeadApp):
    ...
    def run(self):
        ...
        try:   
            ...
            uu,t1,t2,aaw,tn4= st.columns((1,1,8,1,12))
            t1.write("##")
            t1.image('resources/pig2.png', width = 45)
            # t2.write("ภาควิชาวิศวกรรมคอมพิวเตอร์")
            with t2:
                st.write("##")
                Ideal_d1 = '<div align="left"><p style="font-sans-serif:; color: black; font-size: 17px; background-color: white;"> 󠀠 󠀠 󠀠 󠀠 󠀠 󠀠 󠀠 󠀠Bachelor of Computer Engineering.</p>'
                t2.markdown(Ideal_d1, unsafe_allow_html=True)
                # t2.write("มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี")
                Ideal_d2 = '<div align="left"><p style="font-sans-serif:; color: black; font-size: 17px; background-color: white;"> 󠀠 󠀠 󠀠 󠀠 󠀠 󠀠 󠀠 󠀠King Mongkut’s University of Technology Thonburi</p>'
                ...
                Ideal_d4 = '<div align="left"><p style="font-sans-serif:; color: black; font-size: 17px; background-color: white;"> 󠀠 󠀠 󠀠 󠀠 󠀠 󠀠 󠀠 󠀠126 Pracha Uthit Rd, Bang Mot, Thung Khru, Bangkok 10140</p>'
                t2.markdown(Ideal_d4, unsafe_allow_html=True)
                # t4.write("(+66) 0-2470-9388")
                Ideal_d5 = '<div align="left"><p style="font-sans-serif:; color: black; font-size: 17px; background-color: white;"> 󠀠 󠀠 󠀠 󠀠 󠀠 󠀠 󠀠 󠀠📞 Phone: (+66)-2470-9388</p>'
            ...
            if t2.button('This will open a KMUTT Website'):
            ...
            with tn4:
                ...
                st_lottie(lottie2_cod, height=300,  key="codvzq") 
